...
//    }
    ...
    public void test_execute_web() throws Exception {
        ...
        try {
            ...
            final File file = File.createTempFile("apiExtractor-", "");
            file.delete();
            file.mkdirs();
            file.deleteOnExit();
    ...
    public void test_execute_2instance() throws Exception {
        final ApiExtractorServer server1 = new ApiExtractorServer(7070);
        server1.start();
        final ApiExtractorServer server2 = new ApiExtractorServer(7071);
        server2.start();
